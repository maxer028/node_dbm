...
var contact = util.connect(conf.iomsg.url, conf.iomsg.options);
var COLL_USERS = conf.iomsg.users;
var COLL_ARTICLES = conf.iomsg.articles;
var COLL_COMMENTS = conf.iomsg.comments;
